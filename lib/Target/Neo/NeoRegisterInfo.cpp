...
NeoRegisterInfo::NeoRegisterInfo() : NeoGenRegisterInfo(SP::O7) {}
...
void
NeoRegisterInfo::eliminateFrameIndex(MachineBasicBlock::iterator II,
...
unsigned NeoRegisterInfo::getFrameRegister(const MachineFunction &MF) const {
  return SP::I6;
}
